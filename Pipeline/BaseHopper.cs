...
namespace eSSP_example
{
    public class BaseHopper
    {
        ...
        public bool PayoutAmount(int amountToPayout, char[] currency, bool test = false)
        {
        ...
        public void HopperSetupRequest()
        {
            ...
            for (i = 1; i < responseLength; i++)
            {
                switch (response[i])
                {
                    ...
                    case CCommands.SSP_POLL_PAYIN_ACTIVE:
                        Console.WriteLine("Paying active");
                    ...
                    case CCommands.SSP_POLL_DISPENSING:
                        Console.WriteLine("Dispensing coin(s)...\r\n");
